...
//    DONE: Add testing implementation to the RemindersDao.kt
    ...
    fun saveReminderAndGetById() = runBlockingTest {
        ...
        val reminder = FakerUtils.generateRemindersDTOList(1)[0]
    ...
    @Test
    fun getReminderGetByIdNotFound() = runBlockingTest {
    ...
    @Test
    fun deleteReminderByIdAndGettingReminders() = runBlockingTest {
        // Given a reminder inserted
        val reminder = FakerUtils.generateRemindersDTOList(1)[0]
        database.reminderDao().saveReminder(reminder)

        // When deleting a reminder by id
    ...
    fun deleteTasksAndGettingTasks() = runBlockingTest {
        // Given a reminder inserted
        val remindersList = FakerUtils.generateRemindersDTOList(4)
